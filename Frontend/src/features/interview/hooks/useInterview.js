...
export const useInterview = () => {
    ...
    const generateReport = async ({ jobDescription, selfDescription, resumeFile }) => {
        ...
        try {
            ...
            return response.interviewReport // Important: return the data on success
        } catch (error) {
            console.log("Generate Report Error:", error)
            // Show backend error message to the user
            alert(error.response?.data?.message || "Failed to generate report. Please check your inputs.");
