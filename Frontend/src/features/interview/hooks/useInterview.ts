...
export const useInterview = () => {
    ...
    const toggleTask = async (id: string, taskString: string) => {
        try {
    ...
    const evaluateAnswer = async ({ question, userAnswer, jobTitle }: { question: string, userAnswer: string, jobTitle: string }) => {
        try {
